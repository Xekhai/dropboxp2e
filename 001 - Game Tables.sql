...
CREATE TABLE `luckscript_slots_day_winnings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `date` date NOT NULL,
  `day_winnings` decimal(20,6) DEFAULT 0,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB;

ALTER TABLE `luckscript_slots_day_winnings`
ADD INDEX `index_slots_day_winnings_user_id_date` (`user_id` ASC, `date` ASC);
