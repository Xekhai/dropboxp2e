...
class Config {
	const DB_HOST = "db_host"; // Host / address of your database server
	const DB_USERNAME = "db_username"; // DB Username
	const DB_PASSWORD = "db_password"; // DB Password
	const DB_NAME = "db_name"; // Name of your database
